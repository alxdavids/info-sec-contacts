...
This is a partial list of contact points for aspiring graduate students (and post-docs) in Computer Science/Engineering from US-banned countries. The list is maintained primarily by [Kenny Paterson](mailto:kenny.paterson@rhul.ac.uk) and [Emiliano De Cristofaro](mailto:me@emilianodc.com).
...
- Add your information below corresponding to the required details above. 
- Add __two__ spaces at the end of every line to ensure that line breaks are used. 
- Send a __pull request__ when you are done and the information will be merged.

To edit "Table of Contents" run
